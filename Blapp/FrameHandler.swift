...
class FrameHandler: NSObject, ObservableObject,AVCaptureDepthDataOutputDelegate { // new -------------------
   ...
   // private var processFrame : ProcessFrame?
    ...
    private var depthDataOutput: AVCaptureDepthDataOutput? // ----------new -------------------------------
...
// otherwise our frame is displayed sideways on screen
        ...
        guard let depthDataOutput = depthDataOutput else { // new -------------------------------------------
                   print("Failed to create AVCaptureDepthDataOutput")
                   return
               }
        
        if captureSession.canAddOutput(depthDataOutput) { // new ----------------------------------------
